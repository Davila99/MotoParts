                ...
                <div className="bg-slate-50 rounded-lg p-5">
                  ...
                  {pedidoSeleccionado.direccion_entrega && (
                    <div className="space-y-2">
                      ...
                      <p><strong>Código Postal:</strong> {pedidoSeleccionado.direccion_entrega.codigo_postal}</p>
                      <p><strong>País:</strong> {pedidoSeleccionado.direccion_entrega.pais}</p>
                      {pedidoSeleccionado.direccion_entrega.telefono && (
                        <p><strong>Teléfono:</strong> {pedidoSeleccionado.direccion_entrega.telefono}</p>
                      )}
                    </div>
                  )}
                </div>
